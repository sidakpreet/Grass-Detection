...
std::ofstream positiveFile,negativeFile,commonFile,commonFile2;
     ...
     if  ( event == cv::EVENT_LBUTTONDOWN ){
          ...
          for(int i=0;i<size_sample;i++){
			  for(int j=0;j<size_sample;j++){
				  positiveFile<<(int)imgRoi.at<cv::Vec3b>(i,j)[0]<<"\t"
				  ...
				  commonFile2<<countP++<<":"<<(int)imgRoi.at<cv::Vec3b>(i,j)[0]<<" "
							  <<countP++<<":"<<(int)imgRoi.at<cv::Vec3b>(i,j)[1]<<" "
							  <<countP++<<":"<<(int)imgRoi.at<cv::Vec3b>(i,j)[2]<<" ";
			  }
		  }
          positiveFile<<std::endl;
		 ...
		 countN=0;
          for(int i=0;i<size_sample;i++){
			  for(int j=0;j<size_sample;j++){
				  negativeFile<<(int)imgRoi.at<cv::Vec3b>(i,j)[0]<<"\t"
							  <<(int)imgRoi.at<cv::Vec3b>(i,j)[1]<<"\t"
							  <<(int)imgRoi.at<cv::Vec3b>(i,j)[2]<<"\t";
				  commonFile<<(int)imgRoi.at<cv::Vec3b>(i,j)[0]<<"\t"
							  <<(int)imgRoi.at<cv::Vec3b>(i,j)[1]<<"\t"
				...
				commonFile2<<countN++<<":"<<(int)imgRoi.at<cv::Vec3b>(i,j)[0]<<" "
							<<countN++<<":"<<(int)imgRoi.at<cv::Vec3b>(i,j)[1]<<" "
							  <<countN++<<":"<<(int)imgRoi.at<cv::Vec3b>(i,j)[2]<<" ";
			  }
		  }
          negativeFile<<std::endl;
          commonFile<<"-1"<<std::endl;
          commonFile2<<std::endl;
...
int main(int argc, char** argv) {
	...
	negativeFile.open("negativeSamples.txt",std::fstream::app);
	positiveFile.open("positiveSamples.txt",std::fstream::app);
